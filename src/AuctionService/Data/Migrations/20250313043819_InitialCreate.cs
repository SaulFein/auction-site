        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Bracelet = table.Column<string>(type: "text", nullable: true),
                    DialColor = table.Column<string>(type: "text", nullable: true),
                    Condition = table.Column<string>(type: "text", nullable: true),
                    Box = table.Column<bool>(type: "boolean", nullable: false),
                    Papers = table.Column<bool>(type: "boolean", nullable: false),
                    CaseSize = table.Column<string>(type: "text", nullable: true),
                    CaseThickness = table.Column<string>(type: "text", nullable: true),
